# Regole SEO e linguistiche per le schede di grammatica
...
- inglese: `Italian passato prossimo`, `Italian imperfetto tense`, `Italian congiuntivo presente`;
- spagnolo: `El verbo essere en italiano`, `El passato prossimo italiano`;
- francese: `Le verbe essere en italien`, `Le passato prossimo italien`;
