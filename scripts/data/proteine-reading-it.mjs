// Testo italiano della lettura «Proteine: quante ne servono davvero».
//
...
// glosse), che sta in scripts/data/proteine-reading-i18n.mjs.
//
// I cinque livelli contengono LE STESSE INFORMAZIONI, dette con parole via via
// piu' complesse: chi legge solo A1 non perde nessuno dei dodici fatti.
//
//   1. che cos'e' una proteina: 20 amminoacidi, 9 essenziali
//   2. fabbisogno dell'adulto sedentario: 0,83 g/kg (EFSA), 0,90 g/kg (LARN)
//   3. chi si allena: 1,2-2,0 g/kg, ma oltre 1,6 non si guadagna piu' muscolo
//   4. dopo i 65 anni: 1,0-1,2 g/kg
//   5. distribuzione: ~0,4 g/kg per pasto, 3-4 volte al giorno
//   6. qualita': animali complete, legumi poca metionina, cereali poca lisina
//   7. cereali + legumi si completano, ma non serve lo stesso pasto
//   8. vegetariani e vegani: +10-20% sul totale, B12 sempre da integrare
//   9. cheto: meno di 50 g di carboidrati, i primi chili sono acqua, a 12 mesi
//      nessun vantaggio, prestazione peggiore ad alta intensita'
//  10. esempi veri: Carl Lewis vegano (9,86 s nel 1991), Scott Jurek vegano
//      (7 Western States), Zach Bitter a bassi carboidrati (100 miglia in
//      11h19'13" nel 2019) - diete opposte, vertice in entrambi i casi
//  11. mente: il cervello usa il 20% dell'energia e ~120 g di glucosio al
//      giorno; dagli amminoacidi vengono serotonina e dopamina
//  12. il mito della finestra dei 30 minuti
//  13. costo: 10 g di proteine da 10 centesimi a piu' di un euro
...
export const levels = [
  {
    ...
    words: ['la proteina', 'l’amminoacido', 'il fabbisogno', 'il pasto', 'i legumi'],
    questions: [
      'Quante proteine servono ogni giorno a un adulto per ogni chilo di peso?',
      'Quale amminoacido manca ai cereali e quale manca ai legumi?',
      'Che cosa mangia soprattutto il cervello?',
    ],
  },
  {
    id: 'a2',
    ...
    words: ['essenziale', 'la quantità', 'il glucosio', 'l’integratore', 'digerire'],
    questions: [
      'Che cosa dice lo studio del 2018 su chi mangia più di 1,6 grammi per chilo?',
      'Perché dopo i 65 anni il fabbisogno di proteine sale?',
      'Perché i primi chili persi con la dieta chetogenica sono acqua?',
    ],
  },
  {
    id: 'b1',
    ...
    words: ['limitante', 'la sarcopenia', 'la soglia', 'assorbire', 'la riserva'],
    questions: [
      'Perché la ricerca di Morton dice che sopra 1,6 grammi per chilo non serve mangiare di più?',
      'Perché non è necessario mangiare cereali e legumi nello stesso pasto?',
      'Che cosa succede al peso nelle prime settimane di dieta chetogenica, e perché?',
    ],
  },
  {
    id: 'b2',
    ...
    text: p(
      ...
      'Da qui l’intuizione che le cucine tradizionali avevano codificato secoli prima: cereale più legume dà un profilo completo, e pasta e fagioli, riso e lenticchie, pane e ceci, mais e fagioli sono la stessa soluzione trovata in continenti diversi. Va corretto però un punto ripetuto per decenni: la complementarietà non richiede la contemporaneità. L’organismo dispone di un insieme di amminoacidi liberi che si mantiene per ore, e la posizione ufficiale dei nutrizionisti americani ha esplicitamente abbandonato l’obbligo dello stesso pasto.',
    ...
    words: ['il fabbisogno medio', 'la saturazione', 'la digeribilità', 'il precursore', 'la filiera'],
    questions: [
      'Che cosa misura il DIAAS e perché i cereali ottengono un punteggio basso?',
      'In che modo lo studio di Burke sui marciatori mette in discussione la dieta a bassissimi carboidrati nello sport?',
      'Perché la meta-analisi di Schoenfeld e Aragon ridimensiona la finestra anabolica?',
    ],
  },
  {
    id: 'c1',
    ...
    words: ['proteinogenico', 'il plateau', 'la resistenza anabolica', 'la prescrizione', 'endogeno'],
    questions: [
      'Perché una raccomandazione costruita su una media può non valere per una persona precisa?',
      'Che cosa insegna, sul modo in cui nascono i miti, il caso della finestra anabolica?',
    ],
  },
];
...
export const insights = [
  {
    ...
    words: ['il punteggio', 'l’ammollo', 'la germinazione', 'la fibra', 'la fonte'],
    questions: [
      'Che cosa misura il DIAAS che il semplice contenuto di proteine non dice?',
      'Perché l’ammollo e la cottura cambiano il valore nutritivo di un legume?',
    ],
  },
  {
    key: 'app2',
    ...
    words: ['la resistenza', 'il carboidrato', 'lo scatto', 'il deficit', 'il recupero'],
    questions: [
      'Perché per chi corre la maratona i carboidrati contano più delle proteine?',
      'Perché un atleta che deve perdere peso aumenta le proteine invece di diminuirle?',
    ],
  },
  {
    key: 'app3',
    ...
    words: ['la carenza', 'l’aderenza', 'sostenibile', 'ultraprocessato', 'a lungo termine'],
    questions: [
      'Perché l’aderenza nel tempo conta più del tipo di dieta scelto?',
      'Che differenza c’è fra un alimento vegetale e un alimento sano?',
    ],
  },
];
...
export const examples = [
  {
    key: 'esempi',
    text: p(
      'Dalla parte vegetale i nomi non mancano. <strong>Carl Lewis</strong> passò a un’alimentazione vegana nel 1990 e nel 1991, ai Mondiali di Tokyo, corse i 100 metri in 9,86 secondi: record del mondo, e la stagione che lui stesso ha sempre indicato come la migliore della sua carriera. <strong>Scott Jurek</strong> è vegano dal 1999: sette vittorie consecutive alla Western States dal 1999 al 2005 e, nel 2015, il record dell’Appalachian Trail, circa 3.500 chilometri in 46 giorni, 8 ore e 7 minuti.',
      '<strong>Patrik Baboumian</strong>, uomo forte tedesco, vegano dal 2011, l’8 settembre 2013 a Toronto ha camminato per dieci metri con 555 chili sulle spalle: è un primato Guinness, che nel 2015 ha portato a 560 chili. <strong>Venus Williams</strong> è passata a un’alimentazione vegetale nel 2011, dopo la diagnosi della sindrome di Sjögren, e ha continuato a giocare ai massimi livelli. <strong>Lewis Hamilton</strong> è vegano dal 2017 e da allora ha vinto quattro titoli mondiali di Formula 1.',
      'Dall’altra parte c’è chi lavora a carboidrati bassissimi. <strong>Zach Bitter</strong>, il 24 agosto 2019 a Milwaukee, ha corso cento miglia — centosessanta chilometri — in 11 ore, 19 minuti e 13 secondi, record del mondo su pista, e nelle dodici ore ha coperto 168 chilometri. Si allena con pochissimi carboidrati e li reintroduce intorno alle gare. Non è un caso isolato: lo studio FASTER di Jeff Volek, del 2016, ha confrontato venti atleti di ultraresistenza d’élite, dieci a bassi carboidrati e dieci ad alti, e nel primo gruppo ha misurato una capacità di bruciare grassi di 1,54 grammi al minuto contro 0,67. Sono due motori metabolici diversi.',
...
export const myths = [
  {
    key: 'miti',
    text: p(
      '<strong>«Hai trenta minuti dopo l’allenamento».</strong> Falso. La meta-analisi di Schoenfeld e Aragon del 2013 ha mostrato che l’effetto attribuito al momento dipendeva dal fatto che quei gruppi mangiavano più proteine in totale. La finestra è di ore.',
      '<strong>«Il corpo assorbe solo 20-30 grammi di proteine per volta».</strong> Falso. L’intestino assorbe tutto; è la sintesi muscolare che si satura. Nel 2023 Jorn Trommelen ha misurato che cento grammi in un solo pasto continuano a essere usati per costruire tessuti per molte ore.',
      '<strong>«Le proteine rovinano i reni».</strong> Falso in chi ha reni sani: gli studi non lo trovano. È vero il contrario in chi ha già una malattia renale, dove le proteine si limitano su indicazione del medico. Un’avvertenza per i malati è diventata una regola per tutti.',
      '<strong>«Le proteine vegetali sono incomplete».</strong> Falso nella formulazione, vero in parte nella sostanza. Tutti i vegetali contengono tutti e venti gli amminoacidi; alcuni ne hanno poco di uno. Soia, quinoa, grano saraceno e amaranto sono completi da soli.',
      '<strong>«Cereali e legumi vanno mangiati nello stesso piatto».</strong> Falso a metà. Il piatto è ottimo e la tradizione ha ragione, ma la giornata basta: l’idea dell’obbligo è stata ritirata dai nutrizionisti già negli anni Novanta.',
      '<strong>«Senza polvere proteica non si cresce».</strong> Falso. È cibo comodo, non magico: un vasetto di yogurt greco e due fette di pane fanno lo stesso lavoro. La polvere serve a chi fatica ad arrivare al totale, non a chi già ci arriva.',
      '<strong>«Più proteine, più muscoli».</strong> Falso oltre 1,6 grammi per chilo. Senza uno stimolo di allenamento le proteine in più diventano energia o grasso, esattamente come gli altri nutrienti.',
      '<strong>«Le proteine fanno dimagrire».</strong> Vero solo in un senso preciso: saziano più dei carboidrati e dei grassi e costano di più da digerire, quindi aiutano a mangiare meno. Non bruciano niente da sole.'
    ),
  },
];
...
export const practice = [
  {
    key: 'spesa',
    text: p(
      'Ai prezzi di un supermercato italiano, dieci grammi di proteine costano circa così: <strong>10 centesimi</strong> da lenticchie, ceci o fagioli secchi; <strong>25 centesimi</strong> da una polvere di siero di latte; <strong>30 centesimi</strong> da latte o yogurt bianco; <strong>35-40 centesimi</strong> da uova o da petto di pollo; <strong>50 centesimi</strong> dal tofu; <strong>60 centesimi</strong> dallo sgombro in scatola; <strong>più di un euro</strong> da un salume stagionato o da una barretta proteica. Il prezzo non segue la qualità: segue la trasformazione e la pubblicità.',
      '<strong>Comprare i legumi secchi, non in scatola.</strong> Un chilo di lenticchie secche costa circa un terzo dello stesso peso di proteine in scatola e occupa meno spazio. L’ammollo si fa la sera prima; con la pentola a pressione i ceci sono pronti in venti minuti e le lenticchie non hanno bisogno nemmeno dell’ammollo.',
      '<strong>Cucinare una volta per tre giorni.</strong> Una pentola grande di legumi si conserva tre giorni in frigorifero e tre mesi in congelatore, divisa in porzioni. È la differenza fra «mangio legumi quando ho tempo» e «ho sempre legumi pronti».',
      '<strong>Tenere in casa due fonti che non richiedono cottura.</strong> Lo yogurt bianco in confezione grande e le uova risolvono la colazione e la cena veloce senza pensarci. Il vasetto piccolo aromatizzato costa il doppio al chilo e contiene meno proteine.',
      '<strong>Il surgelato non è di serie B.</strong> Piselli, spinaci, fagiolini ed edamame surgelati costano meno del fresco fuori stagione, si conservano per mesi e mantengono i valori nutritivi, perché vengono congelati subito dopo la raccolta.',
      '<strong>Diffidare della parola «proteico» sulla confezione.</strong> Budini, barrette, snack e biscotti «ad alto contenuto proteico» costano da tre a dieci volte di più per grammo di proteina rispetto agli stessi alimenti senza etichetta. La polvere di siero di latte, invece, è onesta: un chilo costa intorno ai venti euro e contiene circa ottocento grammi di proteine.',
      'Un esempio concreto di giornata da circa <strong>95 grammi di proteine</strong> per poco più di quattro euro: 300 grammi di yogurt greco (30 g di proteine), 100 grammi di lenticchie secche cotte (25 g), 80 grammi di pasta integrale (10 g), 200 grammi di tofu (18 g), 30 grammi di mandorle (6 g), 100 grammi di pane (9 g), più verdura e frutta. Sono abbondantemente le proteine di una persona di 70 chili che si allena quattro volte alla settimana.'
    ),
  },
];
...
export const labs = [
  {
    key: 'lab1',
    text: p(
      '<strong>Il fabbisogno</strong> è quanto serve: «il fabbisogno giornaliero di proteine», «coprire il fabbisogno». Viene da <em>bisogno</em>, e le tre costruzioni da conoscere sono <em>avere bisogno di</em> («ho bisogno di proteine»), <em>servire</em> («mi servono le proteine») e <em>bastare</em> («mi basta un uovo»). Attenzione: con <em>servire</em> e <em>bastare</em> il soggetto è la cosa, non la persona — si dice <em>mi servono</em>, non «io servo».',
      '<strong>Assumere</strong> in medicina e in nutrizione significa «introdurre nel corpo»: «assumere un farmaco», «assumere sessanta grammi di proteine». Ma lo stesso verbo significa anche «dare un lavoro a qualcuno» («l’azienda mi ha assunto») e «dare per vero» («assumiamo che sia così»). Tre sensi lontanissimi, un verbo solo: nel dubbio guardate il complemento.',
      'Due parole che sembrano sinonimi e non lo sono: <strong>l’apporto</strong> è quanto un alimento fornisce («l’apporto proteico del tofu»), <strong>la carenza</strong> è quanto manca — e non significa «assenza totale»: «una carenza di ferro» vuol dire troppo poco, non zero. Il verbo è <em>integrare</em>: «integrare la dieta con la vitamina B12», da cui <strong>l’integratore</strong>.',
      'Sulle quantità di cibo l’italiano distingue <strong>la porzione</strong> (quello che si mette nel piatto), <strong>la dose</strong> (una quantità misurata, tipica dei farmaci) e <strong>la razione</strong> (quello che spetta a ciascuno). E occhio a <strong>magro</strong>: «il latte magro» e «la carne magra» vogliono dire senza grassi, ma «una persona magra» vuol dire snella. Il contrario alimentare non è <em>grasso</em> ma <em>intero</em>: <em>latte intero</em>.'
    ),
  },
  {
    key: 'lab2',
    text: p(
      'I rapporti si dicono con <strong>per</strong>: «0,83 grammi <em>per</em> chilo di peso», «venti grammi <em>per</em> pasto». La frequenza invece vuole l’articolo: «tre volte <strong>al</strong> giorno», «due volte <strong>alla</strong> settimana», «una volta <strong>all’</strong>anno». Dire «tre volte per giorno» è l’errore più comune di chi traduce dall’inglese o dallo spagnolo.',
      'I decimali si leggono con la <strong>virgola</strong>: <em>0,83</em> è «zero virgola ottantatré», <em>1,6</em> è «uno virgola sei». Il punto separa le migliaia: <em>1.863</em> è «milleottocentosessantatré». Le percentuali vogliono l’articolo: si dice «<strong>il</strong> venti per cento», mai «venti per cento» da solo.',
      'Gli intervalli hanno tre forme equivalenti: <em>da 1,2 a 2,0 grammi</em>, <em>fra 1,2 e 2,0 grammi</em>, e la forma scritta <em>1,2-2,0</em>, che a voce si legge «da uno virgola due a due». Per approssimare: <strong>circa</strong> sessanta grammi, <strong>sui</strong> sessanta grammi (colloquiale), oppure <strong>una sessantina di</strong> grammi — il suffisso <em>-ina</em> costruisce il numero approssimativo: <em>una decina</em>, <em>una ventina</em>, <em>un centinaio</em>.',
      'Per i confronti: <strong>di più</strong> quando la quantità è generica («mangiare di più»), <strong>in più</strong> quando c’è un numero («dieci grammi in più»). E i moltiplicatori vanno prima: <em>il doppio delle proteine</em>, <em>il triplo del prezzo</em>, <em>la metà del pane</em>, <em>tre volte più caro</em> — non «più caro di tre volte».'
    ),
  },
];

export const sources = [
  'EFSA Panel on Dietetic Products, Nutrition and Allergies, <a href="https://efsa.onlinelibrary.wiley.com/doi/10.2903/j.efsa.2012.2557" target="_blank" rel="noopener">Scientific Opinion on Dietary Reference Values for protein</a>, «EFSA Journal», 2012.',
  'SINU, <a href="https://sinu.it/tabelle-larn-2014/" target="_blank" rel="noopener">LARN - Livelli di Assunzione di Riferimento di Nutrienti ed energia per la popolazione italiana</a>, IV revisione, 2014.',
  'Robert W. Morton et al., <a href="https://bjsm.bmj.com/content/52/6/376" target="_blank" rel="noopener">A systematic review, meta-analysis and meta-regression of the effect of protein supplementation on resistance training-induced gains in muscle mass and strength</a>, «British Journal of Sports Medicine», 2018.',
  'D. Travis Thomas, Kelly Anne Erdman, Louise M. Burke, <a href="https://www.jandonline.org/article/S2212-2672(15)01802-X/fulltext" target="_blank" rel="noopener">Position of the Academy of Nutrition and Dietetics, Dietitians of Canada, and the American College of Sports Medicine: Nutrition and Athletic Performance</a>, 2016.',
  'Vesanto Melina, Winston Craig, Susan Levin, <a href="https://www.jandonline.org/article/S2212-2672(16)31192-3/fulltext" target="_blank" rel="noopener">Position of the Academy of Nutrition and Dietetics: Vegetarian Diets</a>, 2016.',
  'FAO, <a href="https://www.fao.org/4/i3124e/i3124e.pdf" target="_blank" rel="noopener">Dietary protein quality evaluation in human nutrition</a>, FAO Food and Nutrition Paper 92, 2013.',
  'José L. Areta et al., <a href="https://physoc.onlinelibrary.wiley.com/doi/10.1113/jphysiol.2012.244897" target="_blank" rel="noopener">Timing and distribution of protein ingestion during prolonged recovery from resistance exercise alters myofibrillar protein synthesis</a>, «The Journal of Physiology», 2013.',
  'Louise M. Burke et al., <a href="https://physoc.onlinelibrary.wiley.com/doi/10.1113/JP273230" target="_blank" rel="noopener">Low carbohydrate, high fat diet impairs exercise economy and negates the performance benefit from intensified training in elite race walkers</a>, «The Journal of Physiology», 2017.',
  'Jorn Trommelen et al., <a href="https://www.cell.com/cell-reports-medicine/fulltext/S2666-3791(23)00499-4" target="_blank" rel="noopener">The anabolic response to protein ingestion during recovery from exercise has no upper limit in magnitude and duration in vivo in humans</a>, «Cell Reports Medicine», 2023.',
  'Jürgen Bauer et al., <a href="https://www.jamda.com/article/S1525-8610(13)00326-5/fulltext" target="_blank" rel="noopener">Evidence-based recommendations for optimal dietary protein intake in older people: a position paper from the PROT-AGE Study Group</a>, «JAMDA», 2013.',
  'Jeff S. Volek et al., <a href="https://www.sciencedirect.com/science/article/pii/S0026049515003340" target="_blank" rel="noopener">Metabolic characteristics of keto-adapted ultra-endurance runners</a> (studio FASTER), «Metabolism», 2016.',
  'Guinness World Records, <a href="https://www.guinnessworldrecords.com/world-records/110923-heaviest-yoke-carry-travelling-10-m" target="_blank" rel="noopener">Heaviest yoke carry travelling 10 m (male)</a>, Patrik Baboumian, 8 settembre 2013.',
];
