// I 50 aggettivi della prima versione della lezione «Le caratteristiche degli animali»
// (2026-09-24), poi divisa in «caratteristiche fisiche» e «personalità».
//
// Questo file e' la base: contiene le voci originali e gli attrezzi (`trait`, `tr`).
// La divisione in due lezioni, i 17 aggettivi fisici nuovi e le risposte aggiunte per i
// 50 animali nuovi stanno in `traits-vocabulary.mjs`, che e' quello che importa lo script.
//
// Ogni voce:
...
export const tr = (solution, en, es, fr, cs, pl, trk, de, ja) => ({
  solution,
  prompt: { it: en, en, es, fr, cs, pl, tr: trk, de, ja },
});

export const baseTranslationExercises = [
  tr(
    'La formica è molto laboriosa.',
