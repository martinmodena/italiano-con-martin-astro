...
const copy = {
  it: {
    ...
    meta: 'Conosci Martin e Licia, insegnanti madrelingua di italiano online. Lezioni individuali a 12 euro, profili Preply e contatto WhatsApp.',
  ...
  en: {
    ...
    meta: 'Meet Martin and Licia, native online Italian teachers. One-to-one lessons for 12 euros, Preply profiles and WhatsApp contact.',
  ...
  es: {
    ...
    meta: 'Conoce a Martin y Licia, profesores nativos de italiano online. Clases individuales por 12 euros, perfiles de Preply y contacto por WhatsApp.',
  ...
  fr: {
    ...
    meta: 'Découvrez Martin et Licia, professeurs natifs d’italien en ligne. Cours particuliers à 12 euros, profils Preply et contact WhatsApp.',
  ...
  cs: {
    ...
    meta: 'Poznejte Martina a Licii, rodilé online učitele italštiny. Individuální lekce za 12 eur, profily Preply a kontakt přes WhatsApp.',
  ...
  pl: {
    ...
    meta: 'Poznaj Martina i Licię, native speakerów uczących włoskiego online. Indywidualne lekcje za 12 euro, profile Preply i kontakt WhatsApp.',
  ...
  tr: {
    ...
    meta: 'Ana dili İtalyanca olan online öğretmenler Martin ve Licia’yı tanıyın. 12 euroluk bire bir dersler, Preply profilleri ve WhatsApp iletişimi.',
  ...
  de: {
    ...
    price: '12 € pro Unterrichtsstunde',
    ...
    meta: 'Lernen Sie Martin und Licia kennen, muttersprachliche Online-Italienischlehrer. Einzelunterricht für 12 Euro, Preply-Profile und WhatsApp-Kontakt.',
  ...
  ja: {
    ...
    meta: 'オンラインイタリア語講師MartinとLiciaの紹介。1回12ユーロの個人レッスン、Preplyプロフィール、WhatsAppでのお問い合わせ。',
