...
const profiles = {
  en: {
    ...
    martinDescription:
      'Martin loves science, technology and etymology. He connects language, culture and the contemporary world.',
  ...
  es: {
    ...
    martinDescription:
      'A Martin le apasionan la ciencia, la tecnología y la etimología. Relaciona la lengua, la cultura y el mundo actual.',
  ...
  fr: {
    ...
    martinDescription:
      'Martin aime les sciences, la technologie et l’étymologie. Il relie la langue, la culture et le monde contemporain.',
  ...
  pl: {
    ...
    martinDescription:
      'Martin interesuje się nauką, technologią i etymologią. Łączy język, kulturę i współczesny świat.',
  ...
  tr: {
    ...
    martinDescription:
      'Martin bilimi, teknolojiyi ve etimolojiyi sever. Dili, kültürü ve günümüz dünyasını birbirine bağlar.',
  ...
  de: {
    ...
    martinDescription:
      'Martin liebt Wissenschaft, Technologie und Etymologie. Er verbindet Sprache, Kultur und die moderne Welt.',
...
for (const [language, copy] of Object.entries(profiles)) {
  ...
  if (html.includes('class="teachers-section')) {
    html = html.replace(
      /<section class="teachers-section[^>]*>[\s\S]*?(?=<section class="conversion-section")/,
      section
    );
  } else {
  ...
  html = html.replace(
    ...
    `<meta property="og:title" content="${copy.title} | Italiano con Martin">`
  );
  html = html.replace(
